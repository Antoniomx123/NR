...
Reporte$nr <- if_else(Reporte$ultimo_acceso_m == "Nunca","Nuncas",
                      if_else(Reporte$calificacion == 0,"Np",
                              if_else(Reporte$calificacion <= Reporte$REPROBO,"Reprobó",
...
Fase3$Entidad[is.na(Fase3$Entidad)]<-"Resto del país"
...
#Fase8te<-dplyr::select(Fase8tac,id_us,cuatrimestre,MATRICULA,`Bloque seguimiento`,`Bloque ingreso`,BTI,`Tipo alumno`,Contención,Espacios,Visitas,`clave materia`,aula,Nombre.Alumno,Nombre,Apellidos,CORREO_PRINCIPAL,TELEFONO_CELULAR,grupo,asignatura,`Matricula de profesor`,Profesor,Tutor,Supervisor,`Matricula GCA`,`Nombre completo de GCA`,`Matricula RE`,`Nombre completo de RE`,ultimo_acceso_m,ultimo_acceso_auvi,calificacion_potencial,calificacion,Docs,inicio_plus,nr,Correo,`Correo electronico GCA`,`Correo electronico RE`,Correo.Tutor,status,status_plataforma,ciclo_ingreso,FECHA_MATRICULACION,PROGRAMA_CODE,NOMBRE_PROGRAMA,SEXO,FECHA_NAC,modalidad,Entidad,ESTATUS,FECHA_ESTATUS,Asignacion,ESTATUS2,fecha_hora_extraccion,semana)




#Fase 9 cambio de nombres a columnnas####
Fase9<-dplyr::select(Fase8,id_us,cuatrimestre,MATRICULA,`Bloque seguimiento`,`Bloque ingreso`,BTI,`Tipo alumno`,Contención,Espacios,Visitas,`clave materia`,aula,Nombre.Alumno,Nombre,Apellidos,CORREO_PRINCIPAL,TELEFONO_CELULAR,grupo,asignatura,`Matricula de profesor`,Profesor,Tutor,Supervisor,`Matricula GCA`,`Nombre completo de GCA`,`Matricula RE`,`Nombre completo de RE`,ultimo_acceso_m,ultimo_acceso_auvi,calificacion_potencial,calificacion,Docs,inicio_plus,nr,Correo,`Correo electronico GCA`,`Correo electronico RE`,Correo.Tutor,status,status_plataforma,ciclo_ingreso,FECHA_MATRICULACION,PROGRAMA_CODE,NOMBRE_PROGRAMA,SEXO,FECHA_NAC,modalidad,Entidad,ESTATUS,FECHA_ESTATUS,Asignacion,ESTATUS2,fecha_hora_extraccion,semana)
...
Fase9$Asignación[is.na(Fase9$Asignación)]<-"por_asignar"
